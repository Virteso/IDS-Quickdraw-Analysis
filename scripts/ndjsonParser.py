# The following code is used to generate .npy files
# which consist of numpy arrays for easier loading of data for the RNN model
...
def load_and_process_data(file_path, max_seq_len=75):
    ...
    for entry in data:
        ...
        for stroke in drawing:
            ...
            strokes.append((0.0, 0.0)) # Helps the model differentiate between strokes
